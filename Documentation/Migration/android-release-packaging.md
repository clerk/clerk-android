...
The [clean release reproducibility gate](android-release-reproducibility.md) addresses checkout-path-dependent ELF build IDs and verifies two independently assembled release AARs.
