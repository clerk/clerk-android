...
This is deterministic packaged-engine evidence, not a live connectivity or server-availability test. It does not claim an assertion-level audit or retirement of Android's old networking tests. Blank-Bearer clear semantics remain a separate unresolved migration question recorded in the request/response audit.
