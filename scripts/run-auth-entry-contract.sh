...
run_suite OrganizationDefaultsTest \
  absentFormUsesCanonicalEmptyDefaults absentSeverityDefaultsToWarning absentSlugUsesCanonicalEmptyString \
  partialBrandingPreservesLogoAndAdvisory

run_suite OrganizationStateContractTest \
  membershipPreservesAllPermissionKeys nullMembershipPermissionsBecomeEmpty omittedMembershipPermissionsBecomeEmpty \
  activeOrganizationSelectsMatchingMembership noActiveOrganizationPreservesMemberships \
  unknownActiveOrganizationDoesNotSelectAnotherMembership manualDomainPreservesVerifiedStatus \
  automaticInvitationDomainPreservesUnverifiedStatus automaticSuggestionDomainPreservesAbsentVerification \
  enterpriseDomainPreservesExpiredStatus domainPreservesUnknownModeAndVerificationStatus
