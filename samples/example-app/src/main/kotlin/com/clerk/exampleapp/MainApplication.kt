 ...
 * 
 * This class is responsible for initializing Clerk when the app starts.
 * The Hilt annotation enables dependency injection throughout the app.
 * 
 * Requirements:
...
class MainApplication : Application() {
  override fun onCreate() {
     ...
     * 
     * The publishable key is injected from BuildConfig, which reads from gradle.properties.
     * Enable debug mode for development to see detailed logs.
     * 
     * For production:
