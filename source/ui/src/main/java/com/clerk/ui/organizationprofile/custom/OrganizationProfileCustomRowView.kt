...
@Composable
internal fun OrganizationProfileCustomRowView(
  customRow: OrganizationProfileCustomRow,
  onClick: () -> Unit,
  modifier: Modifier = Modifier,
) {
  when (val icon = customRow.icon) {
    is OrganizationProfileRowIcon.Resource -> {
    ...
    is OrganizationProfileRowIcon.Vector -> {
