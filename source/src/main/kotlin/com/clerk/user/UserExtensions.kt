 ...
 *
 * This property compares all available social providers configured for the application
 * with the user's verified external accounts to determine which providers are still
 ...
 *
 * This function concatenates the user's first name and last name with a space between them.
 * If either name is null, it will be treated as an empty string in the concatenation.
 *
