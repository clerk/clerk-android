 ...
 * particularly the redirect URLs that OAuth providers use to return users to the application
...
internal object RedirectConfiguration {
   ...
   *
   * This URL is used as the redirect target when users complete OAuth authentication
   * with external providers. The custom scheme "clerk://" allows the application to
