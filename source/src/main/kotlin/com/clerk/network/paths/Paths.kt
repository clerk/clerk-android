 ...
 *
 * This object organizes API paths into logical groups based on the resource they operate on.
 * All paths are relative to the API base URL and version prefix. The paths are used by
 * Retrofit interfaces to define REST API endpoints.
 *
...
internal object Paths {
   ...
   *
   * These paths handle operations on the authenticated user's profile, settings,
   * and associated resources like email addresses, phone numbers, and sessions.
   */
 ...
 *
 * This object contains constants for parameter names that are frequently used
 * across different API endpoints. Using these constants ensures consistency
 * and reduces the risk of typos in parameter names.
 */
