 ...
 *
 * This class provides a concrete implementation of WildcardType for use in
 * type reflection and serialization operations. It represents wildcard types
 * such as `? extends Number` or `? super String`.
 *
...
private constructor(private val upperBound: Type, private val lowerBound: Type?) : WildcardType {
  ...
  companion object {
     ...
     *
     * This method creates a new WildcardTypeImpl with validation of bounds and
     * canonicalization of the bound types.
     *
