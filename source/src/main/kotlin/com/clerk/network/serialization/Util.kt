 ...
 *
 * This function creates a new immutable map containing all the key-value pairs from the original map.
 * The returned map cannot be modified, providing a safe way to share map data without risk of
