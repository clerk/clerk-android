 ...
 *
 * This data class contains all the configuration settings that control user authentication,
 * sign-up flows, social providers, and other user-related features for the application.
 *
...
data class UserSettings(
   ...
   * @property firstFactors List of first-factor authentication strategies available for this attribute
   * @property usedForSecondFactor Whether this attribute can be used for second-factor authentication
   * @property secondFactors List of second-factor authentication strategies available for this attribute
   ...
   *
   * This class defines how the user registration process behaves, including whether
   * custom actions are required and if legal consent is needed.
   *
   ...
   *
   * This class defines the settings for a specific OAuth provider, including whether
   * it's enabled, required, and how it should be displayed to users.
   *
   ...
   *
   * This class defines what actions users are allowed to perform within the application,
   * such as deleting their own account or creating organizations.
   *
   ...
   *
   * This class defines the behavior and display options for passkey authentication,
   * including autofill capabilities and UI elements.
   *
