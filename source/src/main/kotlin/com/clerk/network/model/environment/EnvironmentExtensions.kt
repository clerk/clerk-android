 ...
 *
 * This property filters the configured social providers to return only those that are
 * enabled for the application. It converts the provider configurations to [OAuthProvider]
 * instances that can be used for authentication flows.
 *
