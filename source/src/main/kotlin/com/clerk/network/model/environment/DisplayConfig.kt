 ...
 *
 * This class contains UI and branding configuration that controls how authentication
 * interfaces are displayed to users, including application branding, preferred sign-in
 * methods, and various URL configurations.
 *
 ...
 *
 * This enum defines the different sign-in methods that can be set as the preferred
 * option for users when they authenticate with the application.
 */
@Serializable
