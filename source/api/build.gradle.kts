...
android {
  ...
  buildTypes {
    ...
    release {
      // Published AARs share an application's classpath with other libraries. Keeping the original
      // Clerk package names avoids collisions between short names generated by different SDKs.
