package com.clerk.api.network.model.backupcodes
 ...
 * stored securely by the user and can only be used once each.
 *
 ...
 * @property updatedAt Timestamp when the backup codes were last updated (Unix timestamp in
 *   milliseconds)
 */
@Serializable
